		...
		<div class="col-xs-11 col-lg-8 welcome">
			...
			<form action="email.php" method="post">
				...
				<div class="row contact-field">
					<div class="col-xs-12">
					<br/><div class="sub-title">Φόρμα επικοινωνίας</div><br/>
				</div>
				
				<div class="row contact-field">
					<div class="col-xs-3">Ονοματεπώνυμο: </div>
					<div class="col-xs-3">
				...
				<div class="row contact-field">
					<div class="col-xs-3">Διεύθυνση: </div>
					<div class="col-xs-3">
				...
				<div class="row contact-field" align="right">
					...
					<div class="col-xs-2">
						<br/><input class="form-control btn btn-primary" type="submit" name="email-us" value="Αποστολή" />
					</div>
				</div>	
