	...
	<div class="general-area-1 row">
		...
		<div class="col-xs-9 col-lg-8 welcome">
			...
			<form action="submit.php" method="post">
				...
				<div class="row contact-field">
					<div class="col-xs-1 asterisk-container"><i class="fa fa-asterisk"></i></div><div class="col-xs-3 content"></div>
					<div class="col-xs-3">
				...
				<div class="row contact-field">
					<div class="col-xs-1 asterisk-container"></div><div class="col-xs-3 content"></div>
					<div class="col-xs-3"><input class="form-control" type="text" name="address" />
					</div>
				</div>	
				...
				<div class="row contact-field">
					<div class="col-xs-1 asterisk-container"><i class="fa fa-asterisk"></i></div>
					<div class="col-xs-1">Captcha: </div><div class="col-xs-2"></div>
					<div class="col-xs-2">
				...
				<div class="row contact-field">
				<div class="col-xs-1 asterisk-container"></div><div class="col-xs-3"></div>
					<div class="col-xs-3">
						<input class="form-control" type="text" id="captcha-text" name="captcha" required="required" placeholder="Type the code shown" />
						<br/>
				...
				<div class="row">
					<div class="col-xs-12">
						<i class="fa fa-asterisk">&nbsp;</i><span class="content required-note"></span><span class="content required-note"></span>
					</div>
				</div>
