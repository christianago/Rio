		...
		<div class="col-xs-11 col-lg-8 welcome">
			...
			<form action="submit.php" method="post">
				...
				<div class="row contact-field">
					<div class="col-xs-12">
					<br/><div class="sub-title content-title">Φόρμα επικοινωνίας</div><br/>
				</div>
				
				<div class="row contact-field">
					<div class="col-xs-3 content">Ονοματεπώνυμο: </div>
					<div class="col-xs-3">
				...
				<div class="row contact-field">
					<div class="col-xs-3 content">Διεύθυνση: </div>
					<div class="col-xs-3">
				...
				<div class="row contact-field">
					<div class="col-xs-3 content">Μήνυμα: </div>
					<div class="col-xs-3">
						<textarea class="form-control" name="message" required="required"></textarea>
					</div>
				</div>	
				
				<div class="row contact-field" align="right">
					<div class="col-xs-3"></div>
					<div class="col-xs-2">
						<br/><input class="form-control btn btn-primary content" type="submit" id="email-us" name="email-us" value="Αποστολή" />
					</div>
				</div>	
