	...
	<div class="col-xs-8 col-lg-offset-1">
		...
		<div class="row">
			<div class="col-xs-6 col-xs-offset-5 col-lg-4 col-lg-offset-5">
				<span class="footer-elem footer-item weather">Weather</span> / 
				<span class="footer-elem footer-item time">Local time</span> / 
				<span class="footer-elem footer-item currency">Currency</span>
			</div>
		</div>
